    ...
    Header.prototype = {
      ...
      tab: function() {
        ...
        for (let i in lis) {
          ...
          lis[i].onmouseenter = function() {
            ...
            $(divs[this.index]).slideDown("slow");
          };
          for (let m in divs) {
      ...
      login: function(event) {
        ...
        if (username === "" || password === "") {
          ...
          ajax.open(
            "POST",
            "http://localhost/webProject/amani/api/v1/login.php"
          );
      ...
      search: function() {
        ...
        if ($("#header-search-div").css("display") === "none") {
          ...
          $("#header-search-div").slideToggle("normal")
        } else {
          $("#header-search-div").slideToggle("normal")
        }
      },
      ...
      //读取cookie，读取购物车数量显示
      getCookie : function(){
           let allproducts =$.cookie("message") ?JSON.parse($.cookie("message")) : [];
           $(".headercount").show();
           $(".headercountspan").html(allproducts.length)
      },
